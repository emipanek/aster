...
def generate_taurex_model(
    ...
    if chemistry_type == "equilibrium":
        # only used if the user explicitly asked for equilibrium/ACE chemistry.
        ...
        chemistry_1 = ACEChemistry(metallicity=metallicity, co_ratio=co_ratio)
