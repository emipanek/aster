...
- `forward_model.py` - `RunTaurexTransmissionModelTool` for generating synthetic transmission spectra, `RunTaurexEmissionModelTool` for emission (dayside flux) spectra
